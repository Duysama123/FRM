...
class UserAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_account" do
    assert_difference("UserAccount.count") do
      post user_accounts_url, params: { user_account: { password: @user_account.password, username: @user_account.username } }
    end
  ...
  test "should update user_account" do
    patch user_account_url(@user_account), params: { user_account: { password: @user_account.password, username: @user_account.username } }
