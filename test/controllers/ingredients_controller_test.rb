...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference("Ingredient.count") do
      post ingredients_url, params: { ingredient: { image_url: @ingredient.image_url, name: @ingredient.name } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { image_url: @ingredient.image_url, name: @ingredient.name } }
