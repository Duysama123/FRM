class UserAccountsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_account.save
        format.html { redirect_to user_account_url(@user_account), notice: "User account was successfully created." }
  ...
  def update
    respond_to do |format|
      if @user_account.update(user_account_params)
        format.html { redirect_to user_account_url(@user_account), notice: "User account was successfully updated." }
  ...
  private
    ...
    def user_account_params
      params.require(:user_account).permit(:username, :password)
    end
end
